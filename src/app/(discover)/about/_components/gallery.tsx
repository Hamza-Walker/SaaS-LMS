...
const MediaGallery = ({
  ...
  const handleActiveMedia = (media: { url: string; type: string }) => {
    // Set active media and reset any video playback
    setActiveMedia(media)
    onActive(media) // Update the parent with the selected media
  }
    ...
    <div className="flex justify-start gap-3 flex-wrap">
      ...
      {userid === groupUserid ? (
        <GlassModal
          ...
          description={
            <>
              Paste an <strong className="text-red-500">embedded</strong> link
              to a YouTube or Loom video. <br />
